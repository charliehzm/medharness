...
## 工作约定
- **分支**：从集成分支 `feat/phase-a` 切 `feat/<task>`；PR 回 `feat/phase-a`，等 Claude review 关闭再合。**勿基于 `main`**（缺设计 + 契约 + B1/H2/M1 修复）。
...
- **外部门禁**：**B6 已满足**（new-api 完全授权已获 2026-05-31）——**BE-0 fork 入仓立即可开**（pin **QuantumNous/new-api** @ tag `v1.0.0-rc.10` · commit `de83ea2f` · git subtree，便于上游 rebase）；BE-7 后跑 **B4 延迟 POC**；BE-6b 前与 Claude 核 **B5 new-api 字段集**。
